...
[![](https://r4pde.netlify.app/cover.png){style="float: left; margin-right: 30px" width="200"}](https://r4pde.netlify.app/)
...
|----|----|----|
| [![](figs/app_trainer.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://edelponte.shinyapps.io/trainer) | [![](figs/app_sadbank.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://edelponte.shinyapps.io/sadbank) | [![](figs/app_fgscdb.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://edelponte.shinyapps.io/fgscdb) |
...
| [![](figs/app_ephembrazil.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://edelponte.shinyapps.io/ephembrazil/) | [![](figs/app_epidemics.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://edelponte.shinyapps.io/epidemics) | [![](figs/app_rusty.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://alvesks.shinyapps.io/rusty-profits/) |
...
| [![](figs/app_trainer2.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://delponte.shinyapps.io/traineR2/) | [![](figs/app_spatial.png){style="border-radius: 0%;  border: 2px solid steelblue" width="150"}](https://delponte.shinyapps.io/spatial) | [![](figs/app_spatial2.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://delponte.shinyapps.io/spatial2/) |
...
| [![](figs/app_gradients.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://delponte.shinyapps.io/gradients/) | [![](figs/apps_warning_systems.png){style="border-radius: 0%; border: 2px solid steelblue" width="150" height="150"}](https://epidemiologiaufv.shinyapps.io/warning-systems/) | [![](figs/aps_edt.png){style="border-radius: 0%; border: 2px solid steelblue" width="150"}](https://epidemiologiaufv.shinyapps.io/EDTCalculator/) |
...
| [![](figs/app_plantrust.png){style="border-radius: 0%; border: 2px solid steelblue" width="150" height="150"}](https://epidemiologiaufv.shinyapps.io/plantrustimages/) | [![](figs/app_mpdefesa.png){style="border-radius: 0%; border: 2px solid steelblue" width="150" height="150"}](https://delponte.shinyapps.io/mpdefesa/) | [![](figs/app_ferrugem_soja.png){style="border-radius: 0%; border: 2px solid steelblue" width="167"}](https://epidemiologiaufv.shinyapps.io/ferrugemsoja/) |
